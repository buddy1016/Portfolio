    ...
    <div>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 sm:gap-8">
        <div className="bg-zinc-900 rounded-xl p-4 sm:p-6 text-center">
          <div className="bg-blue-500/20 w-10 h-10 sm:w-12 sm:h-12 rounded-full flex items-center justify-center mx-auto mb-3 sm:mb-4">
        ...
        <div className="bg-zinc-900 rounded-xl p-4 sm:p-6 text-center">
          ...
          <p className="text-zinc-400 text-sm sm:text-base">g35816339@gmail.com</p>
        </div>
        ...
        <div className="bg-zinc-900 rounded-xl p-4 sm:p-6 text-center">
          ...
          <p className="text-zinc-400 text-sm sm:text-base">Jurong, Singapore</p>
        </div>
      </div>
